...
/// The proof is any of the proofs contained in the `query/block/` module.
pub struct RevelationErcInput<const L: usize> {
    ...
    /// The actual proof generated by query/block module, the top one
...
where
    ...
    [(); num_io::<L>()]:,
{
    /// Arguments are the circuit sets used to generate the query/block proofs
...
mod test {
    ...
    fn test_revelation_api_erc20() -> Result<()> {
        ...
        // Generate a fake query/block proof, taking some inputs from the block db
